...
public class TeleopDiffyWrist extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        clawServo   = hardwareMap.servo.get("claw");            // servo port 0 (Expansion Hub)
        diffyLServo = hardwareMap.servo.get("diffyL");          // servo port 1 (Expansion Hub)
...
//                  telemetry.addData("diffyRPos Servo Angle", "%.1f",diffyRServo.getServoAngle());
            ...
            {
                clawServo.setPosition(0.575);
                diffyLServo.setPosition(0.83);
                diffyRServo.setPosition(0.2);
            } // triangle

            if( gamepad1_circle_now && !gamepad1_circle_last)
            {
                clawServo.setPosition(0.575);
                diffyLServo.setPosition(0.439);
                diffyRServo.setPosition(0.500);
            } // circle
