...
//      gamepad2_share_last      = gamepad2_share_now;       gamepad2_share_now      = gamepad2.share;
    ...
    void processLift(){
        //precision movement
        /* -----moved to inside fast movement logic
        if( (gamepad2.left_trigger > 0.15) && (robot.slideRMotorPos > 0) ){
            robot.slideLMotor.setPower(-1.2(gamepad2.left_trigger));
            robot.slideRMotor.setPower(-1.2(gamepad2.left_trigger));
            ...
            if (robot.chainMotorPos > -940 && robot.slideRMotorPos < 1150) {
                ...
                robot.slideLMotor.setPower(0.20);
                robot.slideRMotor.setPower(0.20);
            }
        }
        else {
