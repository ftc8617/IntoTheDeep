...
//  protected double DRIVE_GEAR_REDUCTION  = 26.851;  // goBilda 26.9:1 (223rpm) gear ratio with 1:1 HDT5 pully/belt
    ...
    public void init(HardwareMap ahwMap, boolean isAutonomous ) {
        ...
        // P=Proportional (speed), I=Integral, D=derivative (overshoot), F=Feedback
        PIDFCoefficients swyftPIDF= new PIDFCoefficients( 10.0, 3.0, 1.0, 0.0, MotorControlAlgorithm.PIDF );
        //TODO: switch back
        slideLMotor.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, swyftPIDF);
        slideRMotor.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, swyftPIDF);
